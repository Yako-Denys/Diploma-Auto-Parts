...
const chartConfig = { value: { label: "Прибыль", color: "#3B82F6" } } satisfies ChartConfig
      ...
      <CardContent>
        <ChartContainer className="aspect-auto h-[310px] w-full" config={chartConfig}>
          <AreaChart accessibilityLayer data={data} margin={{ left: 12, right: 12 }}>
            ...
            <ChartTooltip content={<ChartTooltipContent labelFormatter={formatPrice} indicator="line" />} />
